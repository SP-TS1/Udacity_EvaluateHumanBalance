...
spark = SparkSession.builder.appName('STEDI.read.from.redis.app').getOrCreate()
...
# redisServerRawStreamingDF.writeStream.outputMode('append').format('console').start().awaitTermination()
# TO-DO: cast the value column in the streaming dataframe as a STRING 
redisServerStreamingDF = redisServerRawStreamingDF.selectExpr('cast(value as string) value')
# redisServerStreamingDF.writeStream.outputMode('append').format('console').start().awaitTermination()
...
# testDF = spark.sql('select * from RedisSortedSet')
